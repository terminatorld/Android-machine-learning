...
files=['ENTERTAINMENT','COMMUNICATION','BUSINESS','TOOLS','COMICS','BOOKS_AND_REFERENCE','EDUCATION','TRAVEL_AND_LOCAL','LIFESTYLE','MEDIA_AND_VIDEO','SPORTS','TRANSPORTATION','MUSIC_AND_AUDIO','MEDICAL','HEALTH_AND_FITNESS','LIBRARIES_AND_DEMO','NEWS_AND_MAGAZINES','PERSONALIZATION','PRODUCTIVITY','FINANCE','SOCIAL','PHOTOGRAPHY','SHOPPING']
